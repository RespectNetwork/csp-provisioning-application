...
var countrynamelist = [ {
 ...
 {
    "COUNTRY_CODE": "LY",
    "COUNTRY_DESC": "Libyan Arab Jamahiriya"
 },
 {
    "COUNTRY_CODE": "LI",
 ...
 {
    "COUNTRY_CODE": "MK",
    "COUNTRY_DESC": "Macedonia, The Former Yugoslav Republic of"
 },
 {
    "COUNTRY_CODE": "MG",
 ...
 {
    "COUNTRY_CODE": "GS",
    "COUNTRY_DESC": "South Georgia and The South Sandwich Islands"
 },
 {
    "COUNTRY_CODE": "ES",
    "COUNTRY_DESC": "Spain"
 ...
 {
    "COUNTRY_CODE": "TW",
    "COUNTRY_DESC": "Taiwan, Province of China"
 },
 {
    "COUNTRY_CODE": "TJ",
...
function loadStates(countryName) {
    if(countryName == "US"){
        $("#USA_State").show().val(0);
        $("#USA_State").prop("required", true);
        $("#BillingState").val("");
        $("#BillingState").hide();
...
function loadCountriesAndStates() {
    ...
    for (var i = 0; i < countrynamelist.length; i++){
        listItems+= "<option value='" + countrynamelist[i].COUNTRY_CODE + "'>" + countrynamelist[i].COUNTRY_DESC + "</option>";
    }
    $("#BillingCountry").html(listItems);	

    var listItemsUSA= "";
    for (var i = 0; i < statelist.length; i++){
        listItemsUSA+= "<option value='" + statelist[i].STATE_CODE + "'>" + statelist[i].STATE_DESC + "</option>";
    }
    $("#USA_State").html(listItemsUSA);	
}
