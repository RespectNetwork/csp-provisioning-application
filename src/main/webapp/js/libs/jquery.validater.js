...
$.extend($.validator, {
	...
	messages: {
		...
		atleasttwo: $.validator.format("Please enter at least 2 letters"),
		atleasttwonum: $.validator.format("Please enter at least 2 numbers"),
		spechar: $.validator.format("Please enter at least 1 special characters"),
		passtestletters: $.validator.format("Please enter at least 2 letters"),
		passtestnumbers: $.validator.format("Please enter at least 2 numbers"),
	...
	methods: {
		...
		atleasttwo: function(value, element) {
			...
			if ( returnValuen ) {
				...
				$('#val-numbers').removeClass('validated');	
			};
			if ( returnValuec ) {
				$('#val-characters').addClass('validated');
			} else {
				$('#val-characters').removeClass('validated');	
			};
			if ( returnValuenum ) {
				$('#val-charnum').addClass('validated');
			} else {
				$('#val-charnum').removeClass('validated');	
			};
			return returnValuel;
			return returnValuen;
			return returnValuec;
		...
		passtestletters: function(value, element) {
			return this.optional(element) || /^(.*[a-zA-Z]){2,}/.test(value);
		},
		
		passtestnumbers: function(value, element) {
			var returnValue = this.optional(element) || /^(.*\d){2,}/.test(value);
			return returnValue;
		},
